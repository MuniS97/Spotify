    ...
    <section className="fixed left-0 right-0 bottom-0 h-[116px] bg-[#181818] z-10 flex items-center justify-between p-5">
      <div className="flex items-center gap-4">
        <img
          ...
          src={
            !track
              ? "https://images.unsplash.com/photo-1711994872181-1e112e5e18e0?q=80&w=1530&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              : track?.img
          }
          alt=""
        />
        <div className=" flex flex-col items-start">
          <span className="text-[18px] font-medium text-white">
            {!track ? "MonkeyBird" : track?.name}
          </span>
          <span className="text-[16px] font-medium text-[#b3b3b3]">
            {!track ? "Eminem" : track?.artist}
          </span>
        </div>
